...
const destinations = [
  ...
  },
  {
    ...
    image: Italy,
    introduction:
      "France, known for its advanced technological landscape and high-quality education system, offers a perfect blend of tradition and innovation. With a strong focus on research and development, France is an excellent choice for students seeking cutting-edge education and diverse cultural experiences.",
    sections: [
      {
        title: "Why Study in France?",
        points: [
          "High Academic Standards: France boasts some of the best universities globally, known for their rigorous academic standards.",
          "Tuition-Free Education: Public universities often charge no tuition fees for undergraduate studies.",
          "Research Opportunities: Strong emphasis on research with ample funding and facilities.",
          "Central Location: Located in the heart of Europe, providing easy access to other European countries.",
        ],
  ...
  },
  {
    ...
    image: Italy,
    introduction:
      "uk, known for its advanced technological landscape and high-quality education system, offers a perfect blend of tradition and innovation. With a strong focus on research and development, uk is an excellent choice for students seeking cutting-edge education and diverse cultural experiences.",
    sections: [
      {
        title: "Why Study in uk?",
        points: [
          "High Academic Standards: uk boasts some of the best universities globally, known for their rigorous academic standards.",
          "Tuition-Free Education: Public universities often charge no tuition fees for undergraduate studies.",
          "Research Opportunities: Strong emphasis on research with ample funding and facilities.",
          "Central Location: Located in the heart of Europe, providing easy access to other European countries.",
        ],
  ...
  },
  {
    ...
    image: Italy,
    introduction:
      "poland, known for its advanced technological landscape and high-quality education system, offers a perfect blend of tradition and innovation. With a strong focus on research and development, poland is an excellent choice for students seeking cutting-edge education and diverse cultural experiences.",
    sections: [
      {
        title: "Why Study in poland?",
        points: [
          "High Academic Standards: poland boasts some of the best universities globally, known for their rigorous academic standards.",
          "Tuition-Free Education: Public universities often charge no tuition fees for undergraduate studies.",
          "Research Opportunities: Strong emphasis on research with ample funding and facilities.",
          "Central Location: Located in the heart of Europe, providing easy access to other European countries.",
        ],
...
const Destinations = () => {
  const destinationSelect = destinations.filter(
    (destination) => destination.name === "italy"
  );
