...
function Connect() {
  return (
    <div className="bg-white p-5  lg:p-16 lg:px-40 relative">
      ...
      <section className="flex flex-col gap-4   justify-center py-16 ">
        {/* Image on the left, text on the right */}
        <div className="flex  " >
          <div className="w-1/2 mb-8 relative overflow-hidden">
            <div className="bg-slate-900   sm:h-64 sm:w-60 relative rounded-xl overflow-hidden  ">
              <img
                src={Teacher}
                alt="teacher"
                className="  sm:h-64 sm:w-60 object-cover "
              />
              <div className="absolute hidden md:block top-0  left-48 text-2xl font-bold text-white z-10 ">
                Consultant
              </div>
            </div>
            <div className="absolute hidden md:block top-0  left-48 text-2xl font-bold  ">
              Consultant
            </div>
          </div>
          <div className="w-1/2 md:pl-4 flex items-center justify-center">
            <p className=" text-sm px-2   text-right md:text-left md:text-lg font-poppins sm:font-semibold text-gray-600  ">
              With over four years of experience helping international students,
              I understand the unique challenges you face and is dedicated to
        ...
        <div className="flex ">
          <div className="w-1/2 md:pr-4 flex items-center justify-center">
            <p className=" text-sm px-2  text-left md:text-left md:text-lg font-poppins sm:font-semibold text-gray-600 ">
